...
module "ecs" {
  ...
  services = {
    app = {
      ...
      load_balancer = {
        app = {
          target_group_arn = module.alb.target_group_arns["sticky-notes"]
          container_name   = "app"
          container_port   = 3000
        }
      }
...
module "cloudwatch" {
  ...
  alarm_name        = "sticky-notes-cpu-high"
  alarm_description = "Sticky Notes ECS service CPU usage is high"
  ...
  dimensions = {
    ...
    ServiceName = "sticky-notes-service"
  }
